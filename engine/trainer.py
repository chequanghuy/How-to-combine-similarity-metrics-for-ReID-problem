...
def create_supervised_evaluator(model, metrics,
    ...
    def _inference(engine, batch):
        ...
        with torch.no_grad():
            ...
            feat, base = model(data)
            return feat, pids, camids, base 
...
def do_train(
    ...
    evaluator = create_supervised_evaluator(model, metrics={'r1_mAP': R1_mAP(num_query, max_rank=50, feat_norm=cfg.TEST.FEAT_NORM, load_data=cfg.TEST.LOAD_DATA)}, device=device)
